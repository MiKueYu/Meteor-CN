...
public class BedAura extends Module {
    ...
    public BedAura() {
        super(Categories.Combat, "床光环", "自动在下界和末地放置和炸毁床.");
    }
